...
namespace UnityEngine.XR.ARFoundation.Samples
{
    public class BoneController : MonoBehaviour
    {
        ...
        [SerializeField]
        float spine6AdjustZaxisRotation;
        public float Spine6AdjustZaxisRotation
        {
            get
            {
                return spine6AdjustZaxisRotation;
            }
            set
            {
            // value should be -7.5
                spine6AdjustZaxisRotation = value;
            }
        }


        [SerializeField]
        float spine5AdjustZaxisRotation;
        public float Spine5AdjustZaxisRotation
        {
            get
            {
                return spine5AdjustZaxisRotation;
            }
            set
            {
            // value should be -1.5
                spine5AdjustZaxisRotation = value;
            }
        }
            ...
            for (int i = 0; i < k_NumSkeletonJoints; ++i)
            {
                ...
                if (bone != null)
                {
                    switch (i)
                    {
                        ...
                        case 18:
                            bone.transform.localRotation = joint.localPose.rotation * Quaternion.Euler(0, 0, spine_Z_Rotation.spineRef_Range_Z_Rots[0].zAxisrange);
                            //spine_Z_Rotation.spineRef_Range_Z_Rots[0].zAxis = bone.transform.localEulerAngles.z;
                            break;
                        // spine6, -7.75
                        case 17:
                            bone.transform.localRotation = joint.localPose.rotation * Quaternion.Euler(0, 0, spine6AdjustZaxisRotation);
                            //spine_Z_Rotation.spineRef_Range_Z_Rots[1].zAxis = bone.transform.localEulerAngles.z;

                            break;
                        // spine5, -1.9
                        case 16:
                            //bone.transform.localRotation = joint.localPose.rotation * Quaternion.Euler(0, 0, spine_Z_Rotation.spineRef_Range_Z_Rots[2].zAxisrange);
                            bone.transform.localRotation = joint.localPose.rotation * Quaternion.Euler(0, 0, spine5AdjustZaxisRotation);
                            //spine_Z_Rotation.spineRef_Range_Z_Rots[2].zAxis = bone.transform.localEulerAngles.z;
                            break;

                        // leftupleg, 7.7
                        case 2:
                            bone.transform.localRotation = joint.localPose.rotation * Quaternion.Euler(0, 0, 7.5f);
                            //bone.transform.localRotation = joint.localPose.rotation * Quaternion.Euler(0, 0, spine_Z_Rotation.spineRef_Range_Z_Rots[3].zAxisrange);
                            //spine_Z_Rotation.spineRef_Range_Z_Rots[3].zAxis = bone.transform.localEulerAngles.z;
                            break;
                        // Rightupleg
                        case 7:
                            bone.transform.localRotation = joint.localPose.rotation * Quaternion.Euler(0, 0, 7.5f);
                    ...
                    //if (i == 12)
                    //{
                    //bone.transform.localRotation = joint.localPose.rotation * Quaternion.Euler(0, 0, zRot);
        ...
        //public void EditSpineRotation()
        //{
        //    var spine_bone = m_BoneMapping[13];
        //    var a = spine_bone.transform.localRotation * Quaternion.Euler(0,0,zRot);
        //    spine_bone.transform.localRotation = a;
        //}
